    ...
    <div class="content-page-container full-reset custom-scroll-containers">
        ...
        <div class="container">
            <div class="page-header">
              <h1 class="all-tittles">Modificar - Equipo</h1>
            </div>
        </div>
          ...
          %>
                    <form action="Controlador_Equipos">
                    Nombre:<br>
                    <input class="form-control" type="text" name="txtnombre" value="<%= equi.getNombre()%>"><br>
                    Cantidad:<br>
                    <input class="form-control" type="text" name="txtcantidad" value="<%= equi.getCantidad()%>"><br>
                    Descripcion:<br>
                    <input class="form-control" type="text" name="txtdescripcion" value="<%= equi.getDescripcion()%>"><br>
                   
                <input type="hidden" name="txtid" value="<%= equi.getId()%>">
                <input class="btn btn-primary" type="submit" name="accion" value="Actualizar"> 
                <a href="Controlador_Equipos?accion=listar">Regresar</a>
            </form>
          </div>
