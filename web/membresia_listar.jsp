<%@page import="model.Membresia"%>
<%@page import="model.MembresiaDao"%>
    ...
    <div class="content-page-container full-reset custom-scroll-containers">
        ...
        <div class="container">
            <div class="page-header">
              <h1 class="all-tittles">Listado - Membresia</h1>
            </div>
        </div>
         ...
         <div class="container">            
            <a class="btn btn-success" href="Controlador_Membresia?accion=add">Agregar Membresia</a>
        ...
        <div class="container">               
            <!--<a  class="btn btn-success" href="Agregar.jsp">Nuevo Registro</a> Esto es Cuando se Crea un nuevo Archivo Agregar.jsp -->         
             <table class="table table-bordered"  id="tablaDatos">
                    ...
                    List<Membresia>list=dao.listar();
                    Iterator<Membresia>iter=list.iterator();
                    Membresia mem=null;
                    while(iter.hasNext()){
                    mem=iter.next();                    
                %>
                    ...
                    <tbody id="tbodys">
                        ...
                        <tr>
                            <td class="text-center"><%=mem.getId()%></td>
                            <td class="text-center"><%=mem.getTipo()%></td>
                            <td class="text-center"><%=mem.getPrecio()%></td>                                               
                            
                            <% String Estado=MembresiaDao.getestado(mem.getId());
                            ...
                            <td class="text-center">
                                ...
                                <input type="submit" class="btn btn-warning" data-toggle="modal" data-target="#myModal1" value="Editar"/>  -->
                                 <a href="Controlador_Membresia?accion=editar&id=<%=mem.getId()%>" class="btn btn-primary">Editar</a>
                                <a href="Controlador_Membresia?accion=estado&id=<%=mem.getId()%>" class="btn btn-danger">Anular</a>
                            </td>
                        </tr>
