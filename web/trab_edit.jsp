...
<%@page import="model.TrabajadorDao"%>
<html lang="es">
<head>
    <title>Inicio</title>
    <meta charset="UTF-8">
    ...
    <div class="content-page-container full-reset custom-scroll-containers">
        ...
        <div class="container">
            <div class="page-header">
              <h1 class="all-tittles">Modificar - Trabajador</h1>
            </div>
        </div>
           ...
           <%
              ...
              int id=Integer.parseInt((String)request.getAttribute("idtra"));
              Trabajador tra=(Trabajador)dao.list(id);
          %>
                    <form action="Controlador_Trabajador">
                    Nombres:<br>
                    <input class="form-control" type="text" name="txtnombre" value="<%= tra.getNombres()%>" ><br>
                    Apellidos:<br>
                    <input class="form-control" type="text" name="txtapellido" value="<%= tra.getApellidos()%>" ><br>
                    Correo:<br>
                    <input class="form-control" type="text" name="txtcorreo" value="<%= tra.getCorreo()%>" ><br>
                    Celular:<br>
                    <input class="form-control" type="text" name="txtcelular" value="<%= tra.getCelular()%>" ><br>
                    Usuario:<br>
                    <input class="form-control" type="text" name="txtusuario" value="<%= tra.getUsuario()%>" ><br>
                    Password:<br>
                    <input class="form-control" type="text" name="txtpassword" value="<%= tra.getPassword()%>" ><br> 
                    Tipo_Trabajador:<br>
                    <input class="form-control" type="text" name="txtcargo" value="<%= tra.getCargo()%>" ><br>
                
                <input type="hidden" name="txtid" value="<%= tra.getId()%>">
                <input class="btn btn-primary" type="submit" name="accion" value="Actualizar"> 
                <a href="Controlador_Trabajador?accion=listar">Regresar</a>
            </form>
          </div>
