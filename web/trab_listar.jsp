    ...
    <div class="content-page-container full-reset custom-scroll-containers">
        ...
        <div class="container">
            <div class="page-header">
              <h1 class="all-tittles">Listado - Trabajador</h1>
            </div>
        </div>
         ...
         <div class="container">            
            <a class="btn btn-success" href="Controlador_Trabajador?accion=add">Agregar Empleado</a>
                ...
                %>
                    ...
                    <tbody id="tbodys">
                        ...
                        <tr>
                            ...
                            <td class="text-center"><%= tra.getApellidos()%></td>
                            <td class="text-center"><%= tra.getCorreo()%></td>
                            <td class="text-center"><%= tra.getCelular()%></td>
                            <td class="text-center"><%= tra.getUsuario()%></td>
                            <td class="text-center"><%= tra.getPassword()%></td>
                            <td class="text-center"><%= tra.getCargo()%></td>   
                            <td class="text-center"><%= tra.getEstado()%></td>                           
                            <td class="text-center">
                                
                                <!-- <input type="hidden" value="<//%= rs.getInt("Id_Usuario")%>" id="Editar"/>
                                <input type="submit" class="btn btn-warning" data-toggle="modal" data-target="#myModal1" value="Editar"/>  -->
                                 <a href="Controlador_Trabajador?accion=editar&id=<%=tra.getId()%>" class="btn btn-primary">Editar</a>
                                <a href="Controlador_Trabajador?accion=estado&id=<%=tra.getId()%>" class="btn btn-danger">Anular</a>
                            </td>
                        </tr>
