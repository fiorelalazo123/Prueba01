    ...
    <div class="content-page-container full-reset custom-scroll-containers">
        ...
        <div class="container">
            <div class="page-header">
              <h1 class="all-tittles">Modificar - Membresia</h1>
            </div>
        </div>
           ...
           <div class="container">
            <div class="col-lg-6">
                 <%
                     ...
                     int id=Integer.parseInt((String)request.getAttribute("idmem"));
                     Membresia men =(Membresia)dao.list(id);
                       %>
          
                    <form action="Controlador_Membresia">
                    Nombres:<br>
                    <input class="form-control" type="text" name="txttipo" value="<%= men.getTipo()%>"><br>
                    Apellidos:<br>
                    <input class="form-control" type="text" name="txtprecio" value="<%= men.getPrecio()%>"><br>
                    

                   
                
                <input type="hidden" name="txtid" value="<%=men.getId()%>">
                <input class="btn btn-primary" type="submit" name="accion" value="Actualizar"> 
                <a href="Controlador_Membresia?accion=listar">Regresar</a>
            </form>
          </div>
