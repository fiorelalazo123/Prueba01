    ...
    <div class="content-page-container full-reset custom-scroll-containers">
        ...
        <div class="container">
            <div class="page-header">
              <h1 class="all-tittles">Modificar - Cliente</h1>
            </div>
        </div>
           ...
           <div class="container">
            <div class="col-lg-6">
                 <%
                    ...
                    Celular:<br>
                    <input class="form-control" type="text" name="txtcel" value="<%= cli.getCelular()%>"><br>
                    Dni:<br>
                    <input class="form-control" type="text" name="txtdni" value="<%= cli.getDni()%>"><br>
                    Edad:<br>
                    <input class="form-control" type="text" name="txtedad" value="<%= cli.getEdad()%>"><br>
