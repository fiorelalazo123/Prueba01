    ...
    <div class="content-page-container full-reset custom-scroll-containers">
        ...
        <div class="container">
            <div class="page-header">
              <h1 class="all-tittles">Listado - Cliente</h1>
            </div>
        </div>
         ...
         <div class="container">            
            <a class="btn btn-success" href="Controlador_Cliente?accion=add">Agregar Cliente</a>
                ...
                %>
                    ...
                    <tbody id="tbodys">
                        ...
                        <tr>
                            ...
                            <td class="text-center"><%=cli.getCorreo()%></td>
                            <td class="text-center"><%=cli.getCelular()%></td>
                            <td class="text-center"><%=cli.getDni()%></td>
                            <td class="text-center"><%=cli.getEdad()%></td>
                            <% String Estado=ClienteDao.getestado(cli.getId());
                            ...
                            <td class="text-center">
                                ...
                                <input type="submit" class="btn btn-warning" data-toggle="modal" data-target="#myModal1" value="Editar"/>  -->
                                 <a href="Controlador_Cliente?accion=editar&id=<%=cli.getId()%>" class="btn btn-primary">Editar</a>
                                <a href="Controlador_Cliente?accion=estado&id=<%=cli.getId()%>" class="btn btn-danger">Anular</a>
                            </td>
                        </tr>
