    ...
    <div class="content-page-container full-reset custom-scroll-containers">
        ...
        <div class="container">
            <div class="page-header">
              <h1 class="all-tittles">Modificar - Ejercicios</h1>
            </div>
        </div>
           ...
           <div class="container">
            <div class="col-lg-6">
              ...
              int id=Integer.parseInt((String)request.getAttribute("idejer"));
              Ejercicio ej=(Ejercicio)dao.list(id);
          %>
                    <form action="Controlador_Ejercicios">
                    Nombre:<br>
                    <input class="form-control" type="text" name="txtnombre" value="<%= ej.getNombre()%>"><br>
                    Musculo<br>
                    <input class="form-control" type="text" name="txtmusculo" value="<%= ej.getMusculo()%>"><br>
                   
                
                <input type="hidden" name="txtid" value="<%= ej.getId()%>">
