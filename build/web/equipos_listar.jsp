...
<%@page import="model.Equipos"%>
<%@page import="java.util.List"%>
<%@page import="model.EquiposDao"%>
<html lang="es">
<head>
    <title>Inicio</title>
    <meta charset="UTF-8">
    ...
    <div class="content-page-container full-reset custom-scroll-containers">
        ...
        <div class="container">
            <div class="page-header">
              <h1 class="all-tittles">Listado - Equipos</h1>
            </div>
        </div>
          ...
          <div class="container">            
  <a class="btn btn-success" href="Controlador_Equipos?accion=add">Agregar Equipo</a>
             ...
             <table class="table table-bordered"  id="tablaDatos">
                ...
                %>
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td class="text-center"><%= equi.getId()%></td>
                            <td class="text-center"><%= equi.getNombre()%></td>
                            <td class="text-center"><%= equi.getCantidad()%></td>
                            <td class="text-center"><%= equi.getDescripcion()%></td>
                            <% String Estado=EquiposDao.getestado(equi.getId());
                            ...
                            <td class="text-center">
                                ...
                                <a href="Controlador_Equipos?accion=editar&id=<%=equi.getId()%>" class="btn btn-primary">Editar</a>
                                <a href="Controlador_Equipos?accion=estado&id=<%=equi.getId()%>" class="btn btn-danger">Anular</a>
                            </td>
                        </tr>
