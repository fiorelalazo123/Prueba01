<%@page import="model.Ejercicio"%>
<%@page import="model.EjercicioDao"%>
    ...
    <div class="content-page-container full-reset custom-scroll-containers">
        ...
        <div class="container">
            <div class="page-header">
              <h1 class="all-tittles">Listado - Ejercicio</h1>
            </div>
        </div>
         ...
         <div class="container">            
            <a class="btn btn-success" href="Controlador_Ejercicios?accion=add">Agregar Ejercicio</a>
             ...
             <table class="table table-bordered"  id="tablaDatos">
                ...
                %>
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td class="text-center"><%= ej.getId()%></td>
                            <td class="text-center"><%= ej.getNombre()%></td>
                            <td class="text-center"><%= ej.getMusculo()%></td>
                            ...
                            <td class="text-center">
                                ...
                                <a href="Controlador_Ejercicios?accion=editar&id=<%=ej.getId()%>" class="btn btn-primary">Editar</a>
                                <a href="Controlador_Ejercicios?accion=estado&id=<%=ej.getId()%>" class="btn btn-danger">Anular</a>
                            </td>
                        </tr>
                        <%}%>
                                        </tbody>
