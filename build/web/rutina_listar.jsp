    ...
    <div class="content-page-container full-reset custom-scroll-containers">
        <nav class="navbar-user-top full-reset">
            <ul class="list-unstyled full-reset">
                ...
                <li style="color:#fff; cursor:default;">
                    <span class="all-tittles">Elias Gonzales</span>
                </li>
        ...
        <div class="container">
            <div class="page-header">
              <h1 class="all-tittles">Listado - Rutina</h1>
            </div>
        </div>
         ...
         <div class="container">            
            <a class="btn btn-success" href="Controlador_Rutina?accion=add">Agregar Rutina</a>
        ...
        <div class="container">               
            <!--<a  class="btn btn-success" href="Agregar.jsp">Nuevo Registro</a> Esto es Cuando se Crea un nuevo Archivo Agregar.jsp -->         
             <table class="table table-bordered"  id="tablaDatos">
                    ...
                    List<Rutina>list=dao.listar();
                    Iterator<Rutina>iter=list.iterator();
                    Rutina rut=null;
                    while(iter.hasNext()){
                    rut=iter.next();                    
                %>
                    ...
                    <tbody id="tbodys">
                        ...
                        <tr>
                            <td class="text-center"><%=rut.getId()%></td>
                            <td class="text-center"><%=rut.getDescripcion()%></td>
                            <td class="text-center"><%=rut.getFecha_inicio()%></td>
                            <td class="text-center"><%=rut.getFecha_fin()%></td>    
                            
                            <% String Estado=ClienteDao.getestado(rut.getId());
                                                         if(Estado.equalsIgnoreCase("Activo")){ %>
                                                             
                                                              <td class="text-center text-success"><markactivo><%=Estado %></markactivo></td>   
                                                          <%   }else{ %>
                                                                
                                                                 <td class="text-center text-danger"><markdesactivado><%= Estado %></markdesactivado></td>    
                                                        <%     }
                                                        %> 
                            ...
                            <td class="text-center">
                                ...
                                <input type="submit" class="btn btn-warning" data-toggle="modal" data-target="#myModal1" value="Editar"/>  -->
                                 <a href="Controlador_Rutina?accion=editar&id=<%=rut.getId()%>" class="btn btn-primary">Editar</a>
                                <a href="Controlador_Rutina?accion=estado&id=<%=rut.getId()%>" class="btn btn-danger">Anular</a>
                            </td>
                        </tr>
