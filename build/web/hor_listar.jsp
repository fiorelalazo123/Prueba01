    ...
    <div class="content-page-container full-reset custom-scroll-containers">
        ...
        <div class="container">
            <div class="page-header">
              <h1 class="all-tittles">Listado - Horario</h1>
            </div>
        </div>
         ...
         <div class="container">            
            <a class="btn btn-success" href="Controlador_Horario?accion=add">Agregar Horario</a>
                ...
                %>
                    ...
                    <tbody id="tbodys">
                        ...
                        <tr>
                            ...
                            <td class="text-center"><%= hor.getDia()%></td>
                            <td class="text-center"><%= hor.getHoras()%></td>
                            <% String Estado=HorarioDao.getestado(hor.getId());
                            ...
                            <td class="text-center">
                                ...
                                <input type="submit" class="btn btn-warning" data-toggle="modal" data-target="#myModal1" value="Editar"/>  -->
                                 <a href="Controlador_Horario?accion=editar&id=<%=hor.getId()%>" class="btn btn-primary">Editar</a>
                                <a href="Controlador_Horario?accion=estado&id=<%=hor.getId()%>" class="btn btn-danger">Anular</a>
                            </td>
                        </tr>
