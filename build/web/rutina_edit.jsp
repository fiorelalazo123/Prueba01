    ...
    <div class="content-page-container full-reset custom-scroll-containers">
        ...
        <div class="container">
            <div class="page-header">
              <h1 class="all-tittles">Modificar - Rutina</h1>
            </div>
        </div>
           ...
           <div class="container">
            <div class="col-lg-6">
                 <%
                     ...
                     int id=Integer.parseInt((String)request.getAttribute("idrut"));
                     Rutina rut =(Rutina)dao.list(id);
                       %>
          
                    <form action="Controlador_Rutina">
                    Descripion : <br>
                    <input class="form-control" type="text" name="txtdescripcion" value="<%= rut.getDescripcion()%>"><br>
                    Fecha - inicio :<br>
                    <input class="form-control" type="text" name="txtfecha_i" value="<%= rut.getFecha_inicio()%>"><br>
                    Fecha - fin :<br>
                    <input class="form-control" type="text" name="txtfecha_f" value="<%= rut.getFecha_fin()%>"><br>
           
                   
                
                <input type="hidden" name="txtid" value="<%=rut.getId()%>">
                <input class="btn btn-primary" type="submit" name="accion" value="Actualizar"> 
                <a href="Controlador_Rutina?accion=listar">Regresar</a>
            </form>
          </div>
