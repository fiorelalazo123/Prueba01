    ...
    <div class="content-page-container full-reset custom-scroll-containers">
        ...
        <div class="container">
            <div class="page-header">
              <h1 class="all-tittles">Modificar - Horario</h1>
            </div>
        </div>
          ...
          %>
                    <form action="Controlador_Horario">
                    Dia<br>
                    <input class="form-control" type="date" name="txtfecha" value="<%= hora.getDia()%>" ><br>
                    Hora<br>
                    <input class="form-control" type="text" name="txthora" value="<%= hora.getHoras()%>" ><br>
                   
                
                
                    <input type="hidden" name="txtid" value="<%= hora.getId()%>">
                <input class="btn btn-primary" type="submit" name="accion" value="Actualizar"> 
                <a href="Controlador_Horario?accion=listar">Regresar</a>
            </form>
          </div>
